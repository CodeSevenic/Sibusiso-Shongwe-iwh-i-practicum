...
const PRIVATE_APP_ACCESS = 'pat-eu1-9b9c5964-c226-4c3b-9d85-f6ee952b44d7';

// TODO: ROUTE 1 - Create a new app.get route for the homepage to call your custom object data. Pass this data along to the front-end and create a new pug template in the views folder.
app.get('/', async (req, res) => {
  const properties = ['director', 'movie_name', 'main_actor'];

  const endpoint = `https://api.hubspot.com/crm/v3/objects/2-115072281?properties=${properties.join(
    ','
  )}`;
